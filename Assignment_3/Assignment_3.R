...
vector3 + 1 # can't add 1 to "a" (will error if run directly)
...
# ?iris   # comment this so script runs clean
...
# as.character(vector1) + 5  # would error
as.numeric(as.character(vector1)) + 5  # works

# convert character to numeric
as.numeric(vector3)  # will produce NAs with a warning (non-numeric chars)
...
iris_even <- iris[seq(2, nrow(iris), 2), ] # here's the code to get a list of the even numbers between 2 and 150
